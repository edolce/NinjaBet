...
class SpreadSheets:
    def __init__(self):
        ...
        # Convert the simplified data into a format suitable for Google Sheets
        values_to_save = []
        #     ['Data inizio', 'Data fine', 'Bookmaker' , 'Stake', 'Ritorno', 'Risultato']
        # ]
        for coupon in simplified_data:
            values_to_save.append(
                [coupon['startDate'], coupon['endDate'],coupon["bookmaker"], coupon['stake'], coupon['return'], coupon['result']])
